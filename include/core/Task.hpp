...
public:
    ...
    TimePoint getScheduledFor() const { return scheduled_for_; }
    TimePoint getStartedAt() const { return started_at_; }
    TimePoint getCompletedAt() const { return completed_at_; }
    ...
    bool canRetry() const { return retry_count_ < max_retries_; }
